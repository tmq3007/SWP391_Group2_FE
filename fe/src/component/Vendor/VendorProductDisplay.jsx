        ...
        return (
            ...
            <div className="flex flex-col items-center">
                <div className={"flex justify-start w-[100%] mb-1"}>
                    <Typography><span
                        className={"text-green-500 mr-2 text-2xl font-semibold"}>Top {currentIndex + 1}</span>{b[currentIndex].productName}
                    </Typography>
                </div>
                ...
                <div className="flex mt-4 space-x-4">
                    <button onClick={handlePrevious}
                            className="w-[100px] bg-green-500 text-white p-2 rounded">Previous
                    </button>
                    <button onClick={handleNext} className=" w-[100px] bg-green-500 text-white p-2 rounded">Next
                    </button>
                </div>
            </div>
            );
