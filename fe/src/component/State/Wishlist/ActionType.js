...
export const REMOVE_ITEM_FROM_WISHLIST_REQUEST = 'REMOVE_ITEM_TO_WISHLIST_REQUEST'
export const REMOVE_ITEM_FROM_WISHLIST_SUCCESS = 'REMOVE_ITEM_TO_WISHLIST_SUCCESS'
export const REMOVE_ITEM_FROM_WISHLIST_FAILURE = 'REMOVE_ITEM_TO_WISHLIST_FAILURE'
