...
import {getProductById, updateProductById} from "../State/Product/Action";
...
export const ShopEditProduct = () => {
    ...
    //             const { productName, description, unitBuyPrice, unitSellPrice, discount, stock, measurementUnit, category, shopId } = response.data;
    //             setProductName(productName);
    //             setDescription(description);
    //             setUnitBuyPrice(unitBuyPrice);
    //             setUnitSellPrice(unitSellPrice);
    //             setDiscount(discount);
    //             setStock(stock);
    //             setMeasurementUnit(measurementUnit);
    //             setCategory(category?.categoryId || null);
    //             setShopId(shopId);
    //         });
    //     }
    // }, [dispatch, productId]);
    ...
    const handleUpdateProduct = () => {
        if (!unitBuyPrice || !unitSellPrice || !stock || !category || !shopId) {
        ...
        dispatch(updateProductById(productId, updatedProductData))
            .then(() => {
        ...
        <div className="w-full bg-gray-100 h-screen overflow-y-auto mt-8">
            <div className={"h-screen p-6"}>
                <div className={"flex border-b border-dashed border-border-base pb-5 md:pb-7 "}>
                    <h1 className={"text-lg font-semibold text-heading text-[#1f2937]"}>Edit Product</h1>
                </div>
                ...
                <div className=" flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
                    ...
                    <div
                        ...
                        <p className="text-sm text-body">Add your simple product description and necessary information
                            from here</p>
                    </div>
                ...
                <div
                    ...
                    <div className="flex items-center justify-end">
                        <button
                            ...
                            data-metatip="true"
                            data-label-id="0" onClick={handleUpdateProduct}
                        >
                            Update Product
                        </button>
                    </div>
